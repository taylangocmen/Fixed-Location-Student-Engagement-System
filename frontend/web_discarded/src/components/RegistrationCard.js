...
export class RegistrationCard extends React.Component {
  constructor(props) {
    super(props);
  }
        ...
        <View style={styles.cardContent}>
          <View style={styles.cardRow}>
            ...
            <View style={styles.textInputContainer}>
              <TextInput placeholder="eg. Harry James Potter" style={styles.textInput} />
            </View>
          </View>
          <View style={styles.cardRow}>
            <View style={styles.fieldTextContainer}>
          ...
          <View style={styles.cardRow}>
            ...
            <View style={styles.textInputContainer}>
              <TextInput placeholder="eg. again NOT 'password'" style={styles.textInput} secureTextEntry={true}/>
            </View>
          </View>
        </View>
      </View>
